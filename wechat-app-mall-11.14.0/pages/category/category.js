...
Page({
  ...
  async categories() {
    ...
    // 替换为零食饮料等分类
    const categories = [
      { id: 1, name: '零食', icon: '/images/icon/cart.svg', level: 1, pid: 0 },
      { id: 2, name: '饮料', icon: '/images/icon/cart.svg', level: 1, pid: 0 },
      { id: 3, name: '水果', icon: '/images/icon/cart.svg', level: 1, pid: 0 },
      { id: 4, name: '日用品', icon: '/images/icon/cart.svg', level: 1, pid: 0 },
      { id: 5, name: '其他', icon: '/images/icon/cart.svg', level: 1, pid: 0 }
    ]
    wx.hideLoading()
